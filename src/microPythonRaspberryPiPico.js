...
const DIVECE_OPT = {
    ...
    firmware: 'microPython-standard-raspberryPiPico.uf2'
};
...
class MicroPythonRaspberryPiPico extends CommonPeripheral {
    constructor (runtime, deviceId) {
        super(runtime, deviceId, PNPID_LIST, SERIAL_CONFIG, DIVECE_OPT);
    }
}

class OpenBlockMicroPythonRaspberryPiPicoDevice {
    get DEVICE_ID () {
        return 'microPythonRaspberryPiPico';
    }
    ...
    get MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.modeMenu.input',
                    default: 'input',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.modeMenu.output',
                    default: 'output',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.modeMenu.inputPullup',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.modeMenu.inputPulldown',
    ...
    get LEVEL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.levelMenu.high',
                    default: 'high',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.levelMenu.low',
                    default: 'low',
    ...
    get INTERRUP_MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.InterrupModeMenu.risingEdge',
                    default: 'rising edge',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.InterrupModeMenu.fallingEdge',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.InterrupModeMenu.changeEdge',
                    default: 'change edge',
    ...
    get EOL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.eolMenu.warp',
                    default: 'warp',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico.eolMenu.noWarp',
                    default: 'no-warp',
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroPythonRaspberryPiPico(this.runtime, this.DEVICE_ID);
    }
        ...
        return [
            {
                id: 'pin',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico.category.pins',
                    default: 'Pins',
                ...
                blocks: [
                    {
                        opcode: 'setPinMode',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.pins.setPinMode',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.pins.setDigitalOutput',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.pins.setPwmOutputU16',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.pins.readDigitalPin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.pins.readAnalogPin',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.pins.setServoOutputU16',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.pins.attachInterrupt',
            ...
            },
            {
                id: 'serial',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico.category.serial',
                    default: 'Serial',
                ...
                blocks: [
                    {
                        opcode: 'raspberryPiPicoSerialBegin',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.serial.raspberryPiPicoSerialBegin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.serial.multiSerialPrint',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.serial.multiSerialReadALine',
            ...
            },
            {
                id: 'console',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico.category.console',
                    default: 'Console',
                ...
                blocks: [
                    {
                        opcode: 'consolePrint',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.console.consolePrint',
                    ...
                    },
                    {
                        opcode: 'consoleInput',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico.console.consoleInput',
...
export default OpenBlockMicroPythonRaspberryPiPicoDevice;
